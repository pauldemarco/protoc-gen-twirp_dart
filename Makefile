...
install:
	go install ${LDFLAGS} github.com/pauldemarco/protoc-gen-twirp_dart
...
build_linux:
	GOOS=linux GOARCH=amd64 go build -o ${BINARY} ${LDFLAGS} github.com/pauldemarco/protoc-gen-twirp_dart
